...
/*   Updated: 2026/03/19 05:41:23 by gustavo-lin      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    std::cout << "\n--- Test 4: ScavTrap Guard Gate ---" << std::endl;
    scav1.guardGate();
    
    std::cout << "\n--- Test 5: ScavTrap Drain Energy ---" << std::endl;
    for (int i = 0; i < 55; i++)
    {
        std::cout << i << " ";
        scav1.attack("Goblin");
    ...
    std::cout << "\n--- Test 6: ScavTrap Copy Constructor ---" << std::endl;
    ScavTrap scav3(scav1);
    
    std::cout << "\n--- Test 7: ScavTrap Assignment Operator ---" << std::endl;
    ScavTrap scav4("Scav4");
    scav4 = scav1;
    
    std::cout << "\n--- Test 8: ScavTrap Guard Gate When Dead ---" << std::endl;
